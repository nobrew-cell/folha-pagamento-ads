#!/usr/bin/env bash
# executar.command — Compila (se necessário) e inicia o Sistema de Folha de Pagamento.
...
if [ ! -f "$JAR_PATH" ]; then
    ...
    # Coleta todos os .java — suporte nativo a acentos no macOS (UTF-8 por padrão)
